...
public class ContactsDemo {
	...
	protected void activate() {
		if (Validator.isBlank(FaroPropsValues.OSB_FARO_DEMO_CREATOR_METHOD) ||
			StringUtil.equals(
				FaroPropsValues.OSB_FARO_DEMO_CREATOR_METHOD, "none")) {
		...
		_futureTask = new FutureTask<>(
			() -> {
				...
				while ((System.currentTimeMillis() - startTime) <
					...
					try {
						...
						faroProject.setWeDeployKey(
							FaroPropsValues.OSB_FARO_DEFAULT_WE_DEPLOY_KEY);
				...
				if (StringUtil.equals(
						FaroPropsValues.OSB_FARO_DEMO_CREATOR_METHOD,
						"nanite")) {
