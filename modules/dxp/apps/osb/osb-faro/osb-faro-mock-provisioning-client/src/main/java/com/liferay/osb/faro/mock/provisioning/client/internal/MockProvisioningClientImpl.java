...
public class MockProvisioningClientImpl extends BaseMockProvisioningClientImpl {
	...
	public void addCorpProjectUsers(String corpProjectUuid, String[] userUuids)
		...
		if (corpProjectUuid.equals(FaroPropsValues.OSB_FARO_PROJECT_ID) ||
			corpProjectUuid.equals(FaroPropsValues.OSB_MOCK_PROJECT_ID)) {
	...
	public List<OSBAccountEntry> getOSBAccountEntries(
		...
		if (Validator.isNotNull(
				FaroPropsValues.OSB_FARO_MOCK_OSB_ACCOUNT_ENTRY)) {
	...
	public OSBAccountEntry getOSBAccountEntry(String corpProjectUuid)
		...
		if (corpProjectUuid.equals(FaroPropsValues.OSB_MOCK_PROJECT_ID)) {
		...
		new OSBAccountEntry() {
			{
				...
				setCorpProjectUuid(FaroPropsValues.OSB_MOCK_PROJECT_ID);
		...
		new OSBAccountEntry() {
			{
				...
				setCorpProjectUuid(FaroPropsValues.OSB_FARO_PROJECT_ID);
