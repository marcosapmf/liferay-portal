...
public class FaroPropsValues {
	...
	public static final String OSB_ASAH_BACKEND_LOCAL_URL =
		GetterUtil.getString(PropsUtil.get("osb.asah.backend.local.url"));
	...
	public static final String OSB_ASAH_PUBLISHER_LOCAL_URL =
		GetterUtil.getString(PropsUtil.get("osb.asah.publisher.local.url"));
	...
	public static final String OSB_FARO_DEFAULT_WE_DEPLOY_KEY =
		GetterUtil.getString(
			PropsUtil.get("osb.faro.default.we.deploy.key"),
			System.getenv("OSB_FARO_DEFAULT_WE_DEPLOY_KEY"));

	public static final String OSB_FARO_DEMO_CREATOR_METHOD =
		GetterUtil.getString(
			PropsUtil.get("osb.faro.demo.creator.method"),
			System.getenv("OSB_FARO_DEMO_CREATOR_METHOD"));

	public static final String OSB_FARO_MOCK_OSB_ACCOUNT_ENTRY =
		GetterUtil.getString(
			PropsUtil.get("osb.faro.mock.osb.account.entry"),
			System.getenv("OSB_FARO_MOCK_OSB_ACCOUNT_ENTRY"));

	public static final String OSB_FARO_PROJECT_ID = GetterUtil.getString(
		PropsUtil.get("osb.faro.project.id"),
		System.getenv("OSB_FARO_PROJECT_ID"));

	public static final String OSB_FARO_PROJECT_ID_PREFIX =
		GetterUtil.getString(
			PropsUtil.get("osb.faro.project.id.prefix"),
			System.getenv("OSB_FARO_PROJECT_ID_PREFIX"));

	public static final String OSB_FARO_URL = GetterUtil.getString(
		PropsUtil.get("osb.faro.url"), System.getenv("OSB_FARO_URL"));

	public static final String OSB_ISSUES_EMAIL_ADDRESS = GetterUtil.getString(
		PropsUtil.get("osb.issues.email.address"),
		System.getenv("OSB_ISSUES_EMAIL_ADDRESS"));

	public static final String OSB_MOCK_PROJECT_ID = GetterUtil.getString(
		PropsUtil.get("osb.mock.project.id"),
		System.getenv("OSB_MOCK_PROJECT_ID"));
