...
<%
Map<String, Object> faroConstants = new HashMapBuilder<>().<String, Object>put(
"activityActions", ActivityConstants.getActions()).
.put("applications", FaroConstants.getApplications()).build();
...
.put("cerebroTouchpointsURL", cerebroTouchpointsURL)
...
.put("timeSpans", TimeConstants.getTimeSpans()).build();
