 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/ProductConfigurationListChannel",
	service = ProductConfigurationListChannelResource.Factory.class
)
@Generated("")
public class ProductConfigurationListChannelResourceFactoryImpl
	implements ProductConfigurationListChannelResource.Factory {

	@Override
	public ProductConfigurationListChannelResource.Builder create() {
		return new ProductConfigurationListChannelResource.Builder() {
			...
			public ProductConfigurationListChannelResource build() {
				...
				Function
					<InvocationHandler, ProductConfigurationListChannelResource>
						productConfigurationListChannelResourceProxyProviderFunction =
							ResourceProxyProviderFunctionHolder.
								_productConfigurationListChannelResourceProxyProviderFunction;

				return productConfigurationListChannelResourceProxyProviderFunction.
					apply(
			...
			@Override
			public ProductConfigurationListChannelResource.Builder
			...
			@Override
			public ProductConfigurationListChannelResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public ProductConfigurationListChannelResource.Builder user(
				User user) {
	...
	private static Function
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ProductConfigurationListChannelResource.class.getClassLoader(),
			ProductConfigurationListChannelResource.class);

		try {
			Constructor<ProductConfigurationListChannelResource> constructor =
				(Constructor<ProductConfigurationListChannelResource>)
