...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.RequiredCPOptionExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class RequiredCPOptionExceptionMapper
	extends BaseExceptionMapper<RequiredCPOptionException> {
