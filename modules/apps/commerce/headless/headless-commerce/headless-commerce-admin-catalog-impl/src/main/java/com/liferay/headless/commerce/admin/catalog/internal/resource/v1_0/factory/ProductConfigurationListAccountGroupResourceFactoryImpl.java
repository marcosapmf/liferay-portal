 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/ProductConfigurationListAccountGroup",
	service = ProductConfigurationListAccountGroupResource.Factory.class
)
@Generated("")
public class ProductConfigurationListAccountGroupResourceFactoryImpl
	implements ProductConfigurationListAccountGroupResource.Factory {

	@Override
	public ProductConfigurationListAccountGroupResource.Builder create() {
		return new ProductConfigurationListAccountGroupResource.Builder() {
				...
				Function
					<InvocationHandler,
					 ProductConfigurationListAccountGroupResource>
						productConfigurationListAccountGroupResourceProxyProviderFunction =
							ResourceProxyProviderFunctionHolder.
								_productConfigurationListAccountGroupResourceProxyProviderFunction;

				return productConfigurationListAccountGroupResourceProxyProviderFunction.
					apply(
			...
			@Override
			public ProductConfigurationListAccountGroupResource.Builder
			...
			@Override
			public ProductConfigurationListAccountGroupResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public ProductConfigurationListAccountGroupResource.Builder user(
				User user) {
	...
	private static Function
		<InvocationHandler, ProductConfigurationListAccountGroupResource>
			_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ProductConfigurationListAccountGroupResource.class.getClassLoader(),
			ProductConfigurationListAccountGroupResource.class);

		try {
			Constructor<ProductConfigurationListAccountGroupResource>
				constructor =
					(Constructor<ProductConfigurationListAccountGroupResource>)
	...
	private ComponentServiceObjects
		<ProductConfigurationListAccountGroupResource> _componentServiceObjects;
