 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/ProductConfigurationListAccount",
	service = ProductConfigurationListAccountResource.Factory.class
)
@Generated("")
public class ProductConfigurationListAccountResourceFactoryImpl
	implements ProductConfigurationListAccountResource.Factory {

	@Override
	public ProductConfigurationListAccountResource.Builder create() {
		return new ProductConfigurationListAccountResource.Builder() {
			...
			public ProductConfigurationListAccountResource build() {
				...
				Function
					<InvocationHandler, ProductConfigurationListAccountResource>
						productConfigurationListAccountResourceProxyProviderFunction =
							ResourceProxyProviderFunctionHolder.
								_productConfigurationListAccountResourceProxyProviderFunction;

				return productConfigurationListAccountResourceProxyProviderFunction.
					apply(
			...
			@Override
			public ProductConfigurationListAccountResource.Builder
			...
			@Override
			public ProductConfigurationListAccountResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public ProductConfigurationListAccountResource.Builder user(
				User user) {
	...
	private static Function
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ProductConfigurationListAccountResource.class.getClassLoader(),
			ProductConfigurationListAccountResource.class);

		try {
			Constructor<ProductConfigurationListAccountResource> constructor =
				(Constructor<ProductConfigurationListAccountResource>)
