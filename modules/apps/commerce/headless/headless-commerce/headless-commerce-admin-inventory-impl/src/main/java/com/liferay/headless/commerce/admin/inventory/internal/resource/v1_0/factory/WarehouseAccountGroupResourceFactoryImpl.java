 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-inventory/v1.0/WarehouseAccountGroup",
	service = WarehouseAccountGroupResource.Factory.class
)
@Generated("")
public class WarehouseAccountGroupResourceFactoryImpl
	implements WarehouseAccountGroupResource.Factory {

	@Override
	public WarehouseAccountGroupResource.Builder create() {
		return new WarehouseAccountGroupResource.Builder() {
			...
			public WarehouseAccountGroupResource build() {
				...
				Function<InvocationHandler, WarehouseAccountGroupResource>
					warehouseAccountGroupResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_warehouseAccountGroupResourceProxyProviderFunction;

				return warehouseAccountGroupResourceProxyProviderFunction.apply(
			...
			@Override
			public WarehouseAccountGroupResource.Builder checkPermissions(
			...
			@Override
			public WarehouseAccountGroupResource.Builder httpServletRequest(
			...
			@Override
			public WarehouseAccountGroupResource.Builder httpServletResponse(
			...
			@Override
			public WarehouseAccountGroupResource.Builder preferredLocale(
			...
			@Override
			public WarehouseAccountGroupResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public WarehouseAccountGroupResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, WarehouseAccountGroupResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			WarehouseAccountGroupResource.class.getClassLoader(),
			WarehouseAccountGroupResource.class);

		try {
			Constructor<WarehouseAccountGroupResource> constructor =
				(Constructor<WarehouseAccountGroupResource>)
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, WarehouseAccountGroupResource>
				_warehouseAccountGroupResourceProxyProviderFunction =
					_getProxyProviderFunction();
