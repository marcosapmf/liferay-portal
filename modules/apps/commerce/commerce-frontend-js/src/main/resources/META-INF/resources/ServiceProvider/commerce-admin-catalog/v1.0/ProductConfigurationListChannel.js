...
function resolvePath(
	...
	return `${basePath}${VERSION}${PRODUCT_CONFIGURATION_LISTS_PATH}/${productConfigurationListId}${PRODUCT_CONFIGURATION_LIST_RULES_PATH}/${productConfigurationListChannelId}`;
}

export default function ProductConfigurationListChannel(basePath) {
	return {
		addProductConfigurationListChannel: (
			productConfigurationListId,
			json
