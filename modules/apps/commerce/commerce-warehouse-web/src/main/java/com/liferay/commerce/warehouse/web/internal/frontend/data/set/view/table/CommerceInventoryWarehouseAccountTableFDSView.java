 ...
 */
@Component(
	property = "frontend.data.set.name=" + CommerceInventoryWarehouseFDSNames.COMMERCE_INVENTORY_WAREHOUSE_QUALIFIER_ACCOUNTS,
	service = FDSView.class
)
public class CommerceInventoryWarehouseAccountTableFDSView
