 ...
 */
@Component(
	property = "resource.locator.key=/analytics-settings-rest/v1.0/RecommendationConfiguration",
	service = RecommendationConfigurationResource.Factory.class
)
@Generated("")
public class RecommendationConfigurationResourceFactoryImpl
	implements RecommendationConfigurationResource.Factory {

	@Override
	public RecommendationConfigurationResource.Builder create() {
		return new RecommendationConfigurationResource.Builder() {
			...
			public RecommendationConfigurationResource build() {
				...
				Function<InvocationHandler, RecommendationConfigurationResource>
					recommendationConfigurationResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_recommendationConfigurationResourceProxyProviderFunction;

				return recommendationConfigurationResourceProxyProviderFunction.
					apply(
			...
			@Override
			public RecommendationConfigurationResource.Builder checkPermissions(
			...
			@Override
			public RecommendationConfigurationResource.Builder
			...
			@Override
			public RecommendationConfigurationResource.Builder preferredLocale(
			...
			@Override
			public RecommendationConfigurationResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public RecommendationConfigurationResource.Builder user(User user) {
				_user = user;
	...
	private static Function
		<InvocationHandler, RecommendationConfigurationResource>
			_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			RecommendationConfigurationResource.class.getClassLoader(),
			RecommendationConfigurationResource.class);

		try {
			Constructor<RecommendationConfigurationResource> constructor =
				(Constructor<RecommendationConfigurationResource>)
