...
@Component(
	immediate = true,
	property = "analytics.dxp.entity.page.retriever.class.name=com.liferay.portal.kernel.model.Organization",
	service = DXPEntityPageRetriever.class
)
public class OrganizationPageRetriever implements DXPEntityPageRetriever {
