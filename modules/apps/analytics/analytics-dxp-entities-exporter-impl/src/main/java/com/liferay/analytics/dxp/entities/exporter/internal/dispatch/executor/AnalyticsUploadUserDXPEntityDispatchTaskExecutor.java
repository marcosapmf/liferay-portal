...
@Component(
	...
	property = {
		"dispatch.task.executor.name=" + AnalyticsUploadUserDXPEntityDispatchTaskExecutor.KEY,
		"dispatch.task.executor.type=" + AnalyticsUploadUserDXPEntityDispatchTaskExecutor.KEY
	},
	service = DispatchTaskExecutor.class
)
public class AnalyticsUploadUserDXPEntityDispatchTaskExecutor
	extends BaseDispatchTaskExecutor {

	public static final String KEY = "upload-analytics-user-dxp-entities";
	...
	public void doExecute(
		...
		_analyticsUploadDXPEntityDispatchTaskExecutorHelper.doExecute(
			"user-dxp-entities", dispatchTrigger, dispatchTaskExecutorOutput);
	}
