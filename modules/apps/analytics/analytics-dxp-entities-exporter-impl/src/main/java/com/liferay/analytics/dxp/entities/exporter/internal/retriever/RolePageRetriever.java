...
@Component(
	immediate = true,
	property = "analytics.dxp.entity.page.retriever.class.name=com.liferay.portal.kernel.model.Role",
	service = DXPEntityPageRetriever.class
)
public class RolePageRetriever implements DXPEntityPageRetriever {
