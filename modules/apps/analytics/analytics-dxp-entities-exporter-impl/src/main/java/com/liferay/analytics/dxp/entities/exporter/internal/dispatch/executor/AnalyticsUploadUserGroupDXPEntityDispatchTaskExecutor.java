...
@Component(
	...
	property = {
		"dispatch.task.executor.name=" + AnalyticsUploadUserGroupDXPEntityDispatchTaskExecutor.KEY,
		"dispatch.task.executor.type=" + AnalyticsUploadUserGroupDXPEntityDispatchTaskExecutor.KEY
	},
	service = DispatchTaskExecutor.class
)
public class AnalyticsUploadUserGroupDXPEntityDispatchTaskExecutor
	extends BaseDispatchTaskExecutor {

	public static final String KEY = "upload-analytics-user-group-dxp-entities";
	...
	public void doExecute(
		...
		_analyticsUploadDXPEntityDispatchTaskExecutorHelper.doExecute(
			"user-group-dxp-entities", dispatchTrigger,
