...
@Component(
	immediate = true,
	property = "analytics.dxp.entity.page.retriever.class.name=com.liferay.portal.kernel.model.Group",
	service = DXPEntityPageRetriever.class
)
public class GroupPageRetriever implements DXPEntityPageRetriever {
