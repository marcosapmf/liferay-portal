...
@Component(
	...
	property = {
		"dispatch.task.executor.name=" + AnalyticsUploadGroupDXPEntityDispatchTaskExecutor.KEY,
		"dispatch.task.executor.type=" + AnalyticsUploadGroupDXPEntityDispatchTaskExecutor.KEY
	},
	service = DispatchTaskExecutor.class
)
public class AnalyticsUploadGroupDXPEntityDispatchTaskExecutor
	extends BaseDispatchTaskExecutor {

	public static final String KEY = "upload-analytics-group-dxp-entities";
	...
	public void doExecute(
		...
		_analyticsUploadDXPEntityDispatchTaskExecutorHelper.doExecute(
			"group-dxp-entities", dispatchTrigger, dispatchTaskExecutorOutput);
	}
