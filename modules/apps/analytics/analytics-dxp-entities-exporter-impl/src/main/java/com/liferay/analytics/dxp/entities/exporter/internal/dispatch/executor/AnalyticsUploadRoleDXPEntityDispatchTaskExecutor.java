...
public class AnalyticsUploadRoleDXPEntityDispatchTaskExecutor
	extends BaseDispatchTaskExecutor {

	public static final String KEY = "upload-analytics-role-dxp-entities";
	...
	public void doExecute(
		...
		_analyticsUploadDXPEntityDispatchTaskExecutorHelper.doExecute(
			"role-dxp-entities", dispatchTrigger, dispatchTaskExecutorOutput);
	}
