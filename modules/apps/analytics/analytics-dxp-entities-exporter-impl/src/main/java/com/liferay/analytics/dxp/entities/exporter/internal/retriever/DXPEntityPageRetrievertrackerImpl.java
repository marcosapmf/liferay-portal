...
public class DXPEntityPageRetrievertrackerImpl
	...
	@Override
	public DXPEntityPageRetriever getDXPEntityPageRetriever(String className) {
	...
	protected void activate(BundleContext bundleContext) {
		_serviceTrackerMap = ServiceTrackerMapFactory.openSingleValueMap(
			bundleContext, DXPEntityPageRetriever.class,
			"analytics.dxp.entity.page.retriever.class.name");
	}
	...
	private ServiceTrackerMap<String, DXPEntityPageRetriever>
		_serviceTrackerMap;
