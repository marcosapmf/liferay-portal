...
package com.liferay.analytics.dxp.entities.exporter.internal.helper;
...
@Component(
	immediate = true,
	service = AnalyticsUploadDXPEntityDispatchTaskExecutorHelper.class
)
public class AnalyticsUploadDXPEntityDispatchTaskExecutorHelper {
