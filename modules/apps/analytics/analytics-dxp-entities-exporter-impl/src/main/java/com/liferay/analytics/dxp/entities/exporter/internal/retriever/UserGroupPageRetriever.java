...
@Component(
	immediate = true,
	property = "analytics.dxp.entity.page.retriever.class.name=com.liferay.portal.kernel.model.UserGroup",
	service = DXPEntityPageRetriever.class
)
public class UserGroupPageRetriever implements DXPEntityPageRetriever {
