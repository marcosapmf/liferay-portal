...
@Component(
	...
	property = {
		"dispatch.task.executor.name=" + AnalyticsUploadOrganizationDXPEntityDispatchTaskExecutor.KEY,
		"dispatch.task.executor.type=" + AnalyticsUploadOrganizationDXPEntityDispatchTaskExecutor.KEY
	},
	service = DispatchTaskExecutor.class
)
public class AnalyticsUploadOrganizationDXPEntityDispatchTaskExecutor
	...
	public void doExecute(
		...
		_analyticsUploadDXPEntityDispatchTaskExecutorHelper.doExecute(
			"organization-dxp-entities", dispatchTrigger,
