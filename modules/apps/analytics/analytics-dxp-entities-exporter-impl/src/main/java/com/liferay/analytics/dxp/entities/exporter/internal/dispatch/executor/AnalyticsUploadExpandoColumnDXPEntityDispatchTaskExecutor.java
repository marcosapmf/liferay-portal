...
@Component(
	...
	property = {
		"dispatch.task.executor.name=" + AnalyticsUploadExpandoColumnDXPEntityDispatchTaskExecutor.KEY,
		"dispatch.task.executor.type=" + AnalyticsUploadExpandoColumnDXPEntityDispatchTaskExecutor.KEY
	},
	service = DispatchTaskExecutor.class
)
public class AnalyticsUploadExpandoColumnDXPEntityDispatchTaskExecutor
	...
	public void doExecute(
		...
		_analyticsUploadDXPEntityDispatchTaskExecutorHelper.doExecute(
			"expando-column-dxp-entities", dispatchTrigger,
