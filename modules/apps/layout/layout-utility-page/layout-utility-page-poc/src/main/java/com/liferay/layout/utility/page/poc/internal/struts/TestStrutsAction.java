...
package com.liferay.layout.utility.page.poc.internal.struts;
 ...
 */
@Component(property = "path=/portal/test", service = StrutsAction.class)
public class TestStrutsAction implements StrutsAction {
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.layout.utility.page.test)"
	)
