...
public class DDMStorageAdapterTest {
	...
	public void testInvokeDDMTestStorageAdapter() throws Exception {
		...
		Assert.assertTrue(_containsValue(ddmFormValues, "a"));
		Assert.assertTrue(_containsValue(ddmFormValues, "b"));
	...
	private DDMFormValues _createDDMFormValues() {
		...
		ddmFormValues.addDDMFormFieldValue(
			DDMFormValuesTestUtil.createDDMFormFieldValue(
				"1", "TextField", new UnlocalizedValue("a")));
		ddmFormValues.addDDMFormFieldValue(
			DDMFormValuesTestUtil.createDDMFormFieldValue(
				"2", "TextField", new UnlocalizedValue("b")));
