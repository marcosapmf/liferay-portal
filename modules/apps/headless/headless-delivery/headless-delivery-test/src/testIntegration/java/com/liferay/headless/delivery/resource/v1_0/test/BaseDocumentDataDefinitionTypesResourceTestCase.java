...
import com.liferay.headless.delivery.client.resource.v1_0.DocumentDataDefinitionTypesResource;
 ...
 */
@Generated("")
public abstract class BaseDocumentDataDefinitionTypesResourceTestCase {
	...
	public void setUp() throws Exception {
		...
		_documentDataDefinitionTypesResource.setContextCompany(testCompany);

		DocumentDataDefinitionTypesResource.Builder builder =
			DocumentDataDefinitionTypesResource.builder();

		documentDataDefinitionTypesResource = builder.authentication(
	...
	protected void assertContains(
		Object documentDataDefinitionTypes,
		List<Object> documentDataDefinitionTypeses) {

		boolean contains = false;

		for (Object item : documentDataDefinitionTypeses) {
			if (equals(documentDataDefinitionTypes, item)) {
				contains = true;
		...
		Assert.assertTrue(
			documentDataDefinitionTypeses + " does not contain " +
	...
	protected void assertEquals(
		Object documentDataDefinitionTypes1,
		Object documentDataDefinitionTypes2) {

		Assert.assertTrue(
			documentDataDefinitionTypes1 + " does not equal " +
				documentDataDefinitionTypes2,
			equals(documentDataDefinitionTypes1, documentDataDefinitionTypes2));
	}

	protected void assertEquals(
		List<Object> documentDataDefinitionTypeses1,
		List<Object> documentDataDefinitionTypeses2) {

		Assert.assertEquals(
			documentDataDefinitionTypeses1.size(),
			documentDataDefinitionTypeses2.size());

		for (int i = 0; i < documentDataDefinitionTypeses1.size(); i++) {
			Object documentDataDefinitionTypes1 =
				documentDataDefinitionTypeses1.get(i);
			Object documentDataDefinitionTypes2 =
				documentDataDefinitionTypeses2.get(i);

			assertEquals(
				documentDataDefinitionTypes1, documentDataDefinitionTypes2);
		}
	}
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (Object documentDataDefinitionTypes1 :
				documentDataDefinitionTypeses1) {

			boolean contains = false;

			for (Object documentDataDefinitionTypes2 :
					documentDataDefinitionTypeses2) {
			...
			Assert.assertTrue(
				documentDataDefinitionTypeses2 + " does not contain " +
					documentDataDefinitionTypes1,
				contains);
		}
	}

	protected void assertValid(Object documentDataDefinitionTypes)
		throws Exception {
	...
	protected void assertValid(
		...
		java.util.Collection<Object> documentDataDefinitionTypeses =
			page.getItems();

		int size = documentDataDefinitionTypeses.size();
	...
	protected void assertValid(
		...
		for (String additionalAssertFieldName :
				getAdditionalDocumentDataDefinitionTypeAssertFieldNames()) {
	...
	protected boolean equals(
		...
		if (documentDataDefinitionTypes1 == documentDataDefinitionTypes2) {
			return true;
		}
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("actions", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						documentDataDefinitionType1.getActions(),
						documentDataDefinitionType2.getActions())) {
			...
			if (Objects.equals("assetLibraryKey", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						documentDataDefinitionType1.getAssetLibraryKey(),
						documentDataDefinitionType2.getAssetLibraryKey())) {
			...
			if (Objects.equals("description_i18n", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						documentDataDefinitionType1.getDescription_i18n(),
						documentDataDefinitionType2.getDescription_i18n())) {
			...
			if (Objects.equals("name_i18n", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						documentDataDefinitionType1.getName_i18n(),
						documentDataDefinitionType2.getName_i18n())) {
			...
			if (Objects.equals("siteId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						documentDataDefinitionType1.getSiteId(),
						documentDataDefinitionType2.getSiteId())) {
	...
	protected java.util.Collection<EntityField> getEntityFields()
		...
		if (!(_documentDataDefinitionTypesResource instanceof
				EntityModelResource)) {
		...
		EntityModelResource entityModelResource =
			(EntityModelResource)_documentDataDefinitionTypesResource;
	...
	protected DocumentDataDefinitionType randomDocumentDataDefinitionType()
		...
		return new DocumentDataDefinitionType() {
			{
				assetLibraryKey = RandomTestUtil.randomString();
	...
	protected DocumentDataDefinitionTypesResource
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(
			BaseDocumentDataDefinitionTypesResourceTestCase.class);
	...
	private com.liferay.headless.delivery.resource.v1_0.
		DocumentDataDefinitionTypesResource
			_documentDataDefinitionTypesResource;
